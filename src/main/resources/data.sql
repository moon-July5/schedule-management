...
VALUES (now(),now(),null,false, '66KNJxQuvktGB4W2swshwQ==','$2a$10$DAd.J6N1fv8ecD0UsYKOu.yPnrAQe.lw4pJmLaX6d3fhJ5Bzllw5.','jMhAHd/tL3plV8asm5BrVw==', 'ObiM4MMvrtPBLUsKOLKRpQ==', 'vTkDe3p59kS0E0jaUv9h8Q==','Y9eJz3F996LveX7sZculuA==',15, false);

insert into ACCOUNT_ROLES (ACCOUNT_ID,ROLES)
values (1,'ROLE_ADMIN');

insert into ACCOUNT (CREATED_AT, MODIFIED_AT, DELETED_AT, IS_DELETED, NAME, PASSWORD, ACCOUNT_ID, EMAIL, DEPARTMENT, POSITION, YEARLY, DUTY)
VALUES (now(),now(),null,false, 'BOy243RVJBJY3jaH2PGb8w==','$2a$10$DAd.J6N1fv8ecD0UsYKOu.yPnrAQe.lw4pJmLaX6d3fhJ5Bzllw5.','9cdUlJvRyzUGlf09hCQQRg==', '7ka0XswutP+8zs5O3jiHCQ==', 'vTkDe3p59kS0E0jaUv9h8Q==','p7+H3xZk3+qtymf9Bwl+Tg==',7, false);

insert into ACCOUNT_ROLES (ACCOUNT_ID,ROLES)
values (2,'ROLE_USER');

insert into ACCOUNT (CREATED_AT, MODIFIED_AT, DELETED_AT, IS_DELETED, NAME, PASSWORD, ACCOUNT_ID, EMAIL, DEPARTMENT, POSITION, YEARLY, DUTY)
VALUES (now(),now(),null,false, 'otmdHXusOMNyJmOX5eV6mw==','$2a$10$DAd.J6N1fv8ecD0UsYKOu.yPnrAQe.lw4pJmLaX6d3fhJ5Bzllw5.','Ln02Pz/an6e503b9rLxQVA==', 'txWocglGvpSkvWajAlg8Gg==', 'e9sbZK9Grag43l8xi+EJEA==','T8sAGMymR4WJibqWe1UL+g==',5, false);
