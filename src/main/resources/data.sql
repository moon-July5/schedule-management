...
VALUES (now(),now(),null,false, '66KNJxQuvktGB4W2swshwQ==','$2a$10$eabjAFIFCj9u6nqA9mJL0O7yIBISaEb0ZtDo.3g3UQBPGix1PWiui','jMhAHd/tL3plV8asm5BrVw==', 'ObiM4MMvrtPBLUsKOLKRpQ==', 'vTkDe3p59kS0E0jaUv9h8Q==','Y9eJz3F996LveX7sZculuA==',15, true);

insert into ACCOUNT_ROLES (ACCOUNT_ID,ROLES)
values (1,'ROLE_ADMIN');

insert into ACCOUNT (CREATED_AT, MODIFIED_AT, DELETED_AT, IS_DELETED, NAME, PASSWORD, ACCOUNT_ID, EMAIL, DEPARTMENT, POSITION, YEARLY, DUTY)
VALUES (now(),now(),null,false, 'BOy243RVJBJY3jaH2PGb8w==','$2a$10$eabjAFIFCj9u6nqA9mJL0O7yIBISaEb0ZtDo.3g3UQBPGix1PWiui','9cdUlJvRyzUGlf09hCQQRg==', '7ka0XswutP+8zs5O3jiHCQ==', 'vTkDe3p59kS0E0jaUv9h8Q==','p7+H3xZk3+qtymf9Bwl+Tg==',7, true);
